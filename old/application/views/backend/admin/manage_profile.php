				...
				foreach ($edit_profile as $key => $row):
					...
					<div class="form-group">
						...
						<div class="col-sm-12">
							...
							<img id="blah" src="<?php echo $this->crud_model->get_image_url('admin', $row['admin_id']); ?>"
					...
					<div class="form-group">
						<button type="submit" class="btn btn-success btn-rounded btn-block btn-sm"><i
								class="fa fa-save"></i> <?php echo get_phrase('save'); ?></button>
					</div>
	...
	<div class="col-sm-5">
		<div class="panel panel-info">
			<div class="panel-heading"> <i
					class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('Change Password'); ?></div>
				...
				<div class="panel-body table-responsive">
					...
					<div class="form-group">
						<label class="col-md-12"
							for="example-text"><?php echo get_phrase('Confirm Password'); ?></label>
						<div class="col-sm-12">
					...
					<div class="form-group">
						<button class="btn btn-block btn-info btn-rounded btn-sm"><i
								class="fa fa-save"></i>&nbsp;<?php echo get_phrase('Change Password'); ?></button>
