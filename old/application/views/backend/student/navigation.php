...
<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        <ul class="nav" id="side-menu">
            ...
            <li> <a href="<?php echo base_url(); ?>student/dashboard" class="waves-effect"><i
                        class="ti-dashboard p-r-10"></i> <span
                        class="hide-menu"><?php echo get_phrase('Dashboard'); ?></span></a> </li>



            <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-book p-r-10"></i> <span
                ...
                ?>">
                    ...
                    <li class="<?php if ($page_name == 'class_mate')
                        echo 'active'; ?> ">
            ...
            <li class="<?php if ($page_name == 'payment_history')
                echo 'active'; ?> ">
